...
export class DataGrid {
    ...
    constructor(canvas_id) {
        ...
        const ret = wasm.datagrid_new(ptr0, len0);
     ...
     */
    set_header(header) {
        wasm.datagrid_set_header(this.__wbg_ptr, addHeapObject(header));
    }
    /**
     * @returns {boolean}
     */
    is_out_of_rows_range() {
        const ret = wasm.datagrid_is_out_of_rows_range(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {number} x
     ...
     * @returns {any}
     */
    get_cell_by_position(x, y) {
        const ret = wasm.datagrid_get_cell_by_position(this.__wbg_ptr, x, y);
     ...
     */
    append_rows(js_rows, total_count) {
        wasm.datagrid_append_rows(this.__wbg_ptr, addHeapObject(js_rows), total_count);
    }
    /**
     * @param {number} vertical_step
     * @param {number} horizontal_step
     */
    move_viewport(vertical_step, horizontal_step) {
        wasm.datagrid_move_viewport(this.__wbg_ptr, vertical_step, horizontal_step);
    }
    draw() {
        wasm.datagrid_draw(this.__wbg_ptr);
    }
}
